    ...
    <div class="col-md-12" st-pipe="modelc.callServer"  st-table="modelc.displayed">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" style="overflow: auto;">
                <div class="col-md-8">
                    <label>
                        人员姓名: &nbsp; <input st-search="name" st-input-event="blur" placeholder="请输入公告标题" class="input-sm input-inline form-control" type="search"/>
                    </label>
                </div>
                <div class="col-md-4">
                    <label>
            ...
            <div class="portlet-body" style="overflow: auto;">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tr ng-show="modelc.isLoading">
                        <td colspan="13" ng-show="modelc.isLoading" class="text-center"> 数据加载中 ... </td>
                    </tr>
                    <tr ng-show="modelc.noResult">
                        <td colspan="13" ng-show="modelc.noResult" class="text-center" bgcolor="#f0f8ff"> 无符合条件数据! 请输入条件重新查询...  </td>
                    </tr>
                    ...
                    <tfoot>
                    <tr>
                        <td colspan="13"  st-pagination st-items-by-page="itemsByPage" class="text-center">
                        </td>
                    </tr>
                    </tfoot>
                </table>
