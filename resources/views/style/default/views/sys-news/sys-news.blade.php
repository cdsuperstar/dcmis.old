    ...
    <div class="col-md-12" st-pipe="modelc.callServer"  st-table="modelc.displayed">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" style="overflow: auto;">
                <div class="col-md-8">
                    <label>
                        公告标题: &nbsp; <input st-search="name" st-input-event="blur" placeholder="请输入公告标题" class="input-sm input-inline form-control" type="search"/>
                    </label>
                </div>
                <div class="col-md-4">
                    <label>
            ...
            <div class="portlet-body" style="overflow: auto;">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tr ng-repeat="model in modelc.displayed">
                        ...
                        <td  align="center">
                            <a href="javascript:;" class="dcaedit" title="点击查看详细公告浏览数据！">
