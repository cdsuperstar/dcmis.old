    ...
    <div class="col-md-12" st-pipe="modelc.callServer"  st-table="modelc.displayed">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" style="overflow: auto;">
                <div class="col-md-8">
                    <label>
                        职级名称: &nbsp; <input st-search="name" st-input-event="blur" placeholder="请输入公告标题" class="input-sm input-inline form-control" type="search"/>
                    </label>
                </div>
                <div class="col-md-4">
                    <label>
